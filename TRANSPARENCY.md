I want to be clear: yes, I am 'vibe-coding' a lot of this project. I’m doing this mainly because a project like this seems to be a non-starter for most developers out there. I am seeking a well-rounded virtualizer and x86 emulator for a multitude of platforms—even those with heavy software and hardware restrictions.

My project is ambitious, and I won’t deny my naivety, but I am firm in my goal: I want to create, at the very least, a base that gives others a chance to build something powerful. I want a virtualizer for just about any platform capable of interpreting, dynamically compiling, or virtualizing x86 and x86-64 code, so people can run any x86 OS wherever they want, for any reason at all.
